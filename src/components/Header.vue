              ...
              <router-link to="/comparison">
                ...
                >
                  <path
                    stroke-linecap="round"
                    stroke-linejoin="round"
                    d="M4 4h16a2 2 0 012 2v12a2 2 0 01-2 2H4a2 2 0 01-2-2V6a2 2 0 012-2zm0 2v12h16V6H4zm7 5h2v2h-2v-2z"
                  />
                </svg>
              </router-link>
            </li>
...
import { useComparisonStore } from '../ComparisonStore'; // Import your comparison store
...
const comparisonStore = useComparisonStore(); // Initialize comparison store

// Computed properties for wishlist, cart, and comparison item counts
const wishlistItemCount = computed(() => wishlistStore.items.length);
const totalItems = computed(() => cartStore.totalItems);
const comparisonItemCount = computed(() => comparisonStore.items.length); // Add this for comparison
